...
void intToChar(unsigned int* num, unsigned char* byte);
void charToInt(unsigned int block, unsigned char* word);
void longToChar(unsigned long num, unsigned char* byte);
...
//unsigned int* doSha256(int contentsByteSize, unsigned char plainText[], unsigned int hashed[]);
#endif
